...
export default function ThemeToggle() {
  ...
  const base = 'fixed bottom-4 right-4 sm:top-4 sm:right-4 sm:bottom-auto z-[60] rounded-full border px-4 py-2 text-sm font-medium backdrop-blur-md shadow-md transition-colors';
